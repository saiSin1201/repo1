...
public class TToupiaoDAO extends HibernateDaoSupport
{
	...
	// property constants
	public static final String TOUPIAO_NAME = "toupiaoName";

	public static final String TOUPIAO_DATE = "toupiaoDate";
	...
	public List findByToupiaoName(Object toupiaoName)
	{
		return findByProperty(TOUPIAO_NAME, toupiaoName);
	}

	public List findByToupiaoDate(Object toupiaoDate)
	{
		return findByProperty(TOUPIAO_DATE, toupiaoDate);
	}
